...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if KeySystem == "Mjs264xDHSY9Xjkk7L3n2aaag7k" then   
screenGui:Destroy()

    loadstring(game:HttpGet("https://raw.githubusercontent.com/PiterNaGitHub/PiterNaGitHub/main/macro.lua"))() --Your Script
  
  end
end)

GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("https://workink.net/1VIo/lze48bi0") 
end) 
